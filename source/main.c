...
#include "source/app_hw/task_servo.h"
#include "source/app_hw/task_rtc.h"
#include "source/app_hw/task_mag.h"
#include "source/app_hw/task_imu.h"
#include "source/app_hw/task_lcd.h"
#include "source/app_hw/task_motor.h"
#include "source/app_hw/task_amplifier.h"
#include "source/app_hw/task_pid.h"
#include "source/app_hw/alarm_commander.h"
 ...
 *   BT stack initialization. Initialize hardware peripherals and create tasks.
 *
 *   @param: None
 *
 *   @return: None
...
int main(void)
{
    ...
    CY_ASSERT(cy_result == CY_RSLT_SUCCESS);
    ...
    /* Initialize all protocol communications here */
    cy_result = i2c_init();
    CY_ASSERT(cy_result == CY_RSLT_SUCCESS);
